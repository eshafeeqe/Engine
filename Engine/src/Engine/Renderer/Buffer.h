...
namespace Engine
{
    ...
    static uint32_t ShaderDataTypeSize( ShaderDataType type)
    {
        ...
        EG_CORE_ASSERT(false, "Unkown ShareDataType!")
        return 0;
    };
    ...
    struct BufferElement
    {
        ...
        uint32_t GetComponentCount() const
        {
            ...
            EG_CORE_ASSERT(false, "Unkown ShaderDatatype!")
            return 0; 
        }
    };
    ...
    public:
        ...
        //std::vector<BufferElement>::const_iterator begin() {return m_Elements.begin();}
